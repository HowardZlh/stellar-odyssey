...
> see the highlights below, or [just start playing](https://stellar.guushu.com/en).
...
**Online**: just visit [stellar.guushu.com/en](https://stellar.guushu.com/en) — nothing to install.
...
Some advanced content (close-view detail layers / galaxy & universe tour sequences / unlimited event demos / unlimited access to the Astronomy Lab's Body Observatory) is available as a **time-limited supporter unlock**, while the free experience stays intact (all L1/L2 features and every far-view science note are unaffected, the Observatory has a free daily quota, and **the Sgr A\* black-hole photon ring and Orion Nebula close-view detail layers are free for everyone**). Tiers: **Week Pass ¥6 / Month Pass ¥15 / Year Pass ¥88** (Ko-fi reference: $1 / $2.5 / $13).

Support channels (in recommended order): **Afdian** (recommended — automatic order-number redemption on the unlock page, unlocks instantly) → Alipay QR pay (token issued automatically and access unlocks instantly after payment) → Mianbaoduo (fallback — pay by QR with no account needed, automatic order-ID redemption) → Ko-fi (overseas fallback, manual review). Purchase and redeem at [stellar.guushu.com/unlock](https://stellar.guushu.com/unlock); full guide in [docs/en/unlock-guide.md](docs/en/unlock-guide.md). Supporter nicknames and messages (both optional) are listed on the donor roster and in the [Contributor Universe](https://stellar.guushu.com/contributors).
...
- ⚡ Afdian (recommended — automatic order-number redemption on the unlock page): [afdian.com/a/stellar-odyssey](https://afdian.com/a/stellar-odyssey)
- 🔓 Unlock page (Alipay QR pay — token issued automatically and access unlocks instantly after payment; also where Afdian / Mianbaoduo order numbers are redeemed): [stellar.guushu.com/unlock](https://stellar.guushu.com/unlock)
