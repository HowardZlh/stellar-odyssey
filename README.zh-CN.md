...
- **中英双语**：界面、3D 天体标签与科普说明随控制面板 zh/EN 开关即时切换（或 `?lang=en` 启动）；英文入口 [stellar.guushu.com/en](https://stellar.guushu.com/en) 默认英文界面
...
| [docs/lunar-eclipse-lab.md](docs/lunar-eclipse-lab.md) | 天文实验室：月食（血月）观测指南（2029 最深全食 / 2026 偏食 / 2027 半影食 / 1992 皮纳图博 L=0） |
...
部分高级内容（近观细节层 / 银河系与宇宙视角巡游序列 / 事件演示不限次 / 天文实验室「天体观察站」不限次）为**支持者限时解锁**，免费体验保持完整（L1/L2 全部功能与全部远观科普不受影响，观察站每日有免费观察额度；**人马座 A\* 黑洞光子环与猎户座星云的近观细节层对所有用户免费开放**）。档位：**周卡 ¥6 / 月卡 ¥15 / 年卡 ¥88**（Ko-fi 参考价 $1 / $2.5 / $13）。

支持渠道（按推荐顺序）：**爱发电**（推荐，支付后在解锁页凭订单号自动兑换、即时解锁）→ 支付宝扫码（支付后自动发码、即时解锁）→ 面包多（备选，扫码即付无需注册，订单号自动兑换）→ Ko-fi（海外备选，人工核验）。购买与兑换见 [stellar.guushu.com/unlock](https://stellar.guushu.com/unlock)，详细说明见 [docs/unlock-guide.md](docs/unlock-guide.md)。支持者昵称与留言（均可选）将记入捐赠名单与[贡献者宇宙](https://stellar.guushu.com/contributors)。

## 💖 赞助支持

如果这个宇宙曾让你停下滚轮多看了一会儿，欢迎支持项目——支持即可解锁高级内容（见上节「支持者解锁」），昵称与留言可记入贡献者名单：

- ⚡ 爱发电（推荐，支付后在解锁页凭订单号自动兑换）：[afdian.com/a/stellar-odyssey](https://afdian.com/a/stellar-odyssey)
- 🔓 解锁页（支付宝扫码，支付后自动发码即时解锁；爱发电 / 面包多订单号也在此兑换）：[stellar.guushu.com/unlock](https://stellar.guushu.com/unlock)
