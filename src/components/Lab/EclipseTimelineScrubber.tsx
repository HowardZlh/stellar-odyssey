 ...
 *
 * 契约 C7 纪律：锚点列表**数据驱动**——组件只消费 `EclipseTimelineAnchor[]`
 * （`{ key, tSec, labelKey }`），禁止硬编码 5 个锚点；月食条目将以 7 锚点
 * （P1/U1/U2/食甚/U3/U4/P4，部分事件锚点缺省）复用本组件。
 * 变速档随 M3（导览变速/真实速度分档），本阶段播放固定 ×1。
 *
...
import type { EclipseTimelineAnchor, EclipseTimelineWindow } from '@/utils/solarEclipseLab';
