    ...
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-lg bg-space-panel px-5 py-3 text-xs text-gray-300 backdrop-blur">
      <div className="flex items-center gap-4">
        <p>
          ...
          垂直展开（银河系视角下生效；银河系整体 morph
          为扁旋转椭球体：银盘/超新星/特殊天体随增益展开，含高度指示线）·
          ...
          <span className="text-gray-500">
            ...
            开启后整个银盘 morph 为扁旋转椭球体（正面/俯视轮廓仍为圆形、旋臂俯视可辨，侧视旋臂图案被垂直弥散属预期权衡），超新星随盘抬升、银晕增亮、尘埃带渐隐；
            ...
            大尺度背景为 2MASS 红移巡天（2MRS）约 4.3 万个真实星系点云（椭圆偏黄/旋涡偏蓝白，
            室女座团聚集与银道空带为真实数据；红移距离系哈勃流近似有指状效应、近距误差与
            银道遮挡带三项失真，银道空带是尘埃遮挡的观测限制非真实空洞），程序化宇宙网降为氛围底层；
            银河系侧视可见外盘 S 形 HI 翘曲（Levine et al. 2006，盘缘振幅经艺术化放大以侧视可辨）与
            银心上下费米气泡弥散双泡（Su et al. 2010，伽马射线辉光以淡紫/品红艺术化呈现，可在显示选项关闭）
          </span>
        </p>
        <button
          type="button"
