...
export const SPECIAL_BODIES: readonly SpecialBodyData[] = [
  ...
  // ---- 可选项扩展（需求 3.1.5 可选特殊天体，L3） ----
  {
    ...
    dataSource: 'Miller-Jones et al. (2021), Science；NASA Chandra 天鹅座X-1 观测',
  },
  {
    id: 'wr-124',
    name: 'WR 124',
  ...
  },
  {
    ...
    factsZh: [
      ...
      {
        label: '量天尺',
        value: '周光关系（Leavitt 1912）：光变周期越长光度越高，据此可测星系际距离——宇宙距离阶梯的基石',
      },
  ...
  },
  {
    ...
    factsZh: [
      ...
      { label: '剪影', value: '在背景发射星云 IC 434 的氢α红光前形成马头形剪影' },
  ...
  // ---- 可选项扩展（需求 3.1.5 可选河外对象，L4） ----
  {
    ...
    dataSource: 'NASA HST 触须星系观测（NGC 4038/4039）；Toomre & Toomre (1972)',
  },
  {
    id: 'cluster-lensing',
    ...
    color: '#a8d4ff',
    factsZh: [
      { label: '原理', value: '星系团总质量（含暗物质）弯曲时空，使背景星系的光线偏折' },
      { label: '光弧', value: '背景星系被拉伸放大成弧状虚像（爱因斯坦广义相对论预言）' },
      { label: '原型', value: 'Abell 370 星系团（首个发现引力透镜弧，距离约 48 亿光年）' },
      { label: '示意说明', value: '弧置于室女座星系团位置便于观察（示意，已登记）' },
    ],
    dynamicsZh:
      '背景星系的光被星系团引力场弯曲成蓝色弧状拉伸虚像，围绕团中心分布——暗物质质量分布的直接探针',
    dataSource: 'Soucail et al. (1987) Abell 370 巨弧；NASA HST Frontier Fields',
  },
  {
    id: 'grb-221009a',
    ...
    color: '#e8f4ff',
    factsZh: [
      { label: '原型', value: 'GRB 221009A（2022-10-09，史上最亮伽马暴，绰号 BOAT）' },
      { label: '距离', value: '约 20 亿光年（红移 z ≈ 0.151）' },
      { label: '本质', value: '大质量恒星核坍缩，相对论喷流恰好指向地球' },
      { label: '演示说明', value: '真实 GRB 为一次性事件，此处周期性重放为演示示意（已登记）' },
    ],
    dynamicsZh:
